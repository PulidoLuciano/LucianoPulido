        ...
        <main className="max-w-screen-mobileS px-2 mx-auto">
            ...
            </div>
            {
                ...
                <Form className="flex flex-col pb-4" onSubmit={handleLogin}>
                    <label htmlFor="email" className="font-semibold pb-1 pt-2">E-mail</label>
                    <input type="email" required={true} name="email" id="email" className="bg-transparent border-b-2 border-primary-light rounded-sm outline-none"/>
                    ...
                    <div className="mt-2 pb-1 relative flex items-center gap-1">
                        <input type="checkbox" name="keepLoggedIn" id="keepLoggedIn" className="opacity-0 cursor-pointer size-6 peer z-10"/> 
                        ...
                        <label htmlFor="keepLoggedIn" className="cursor-pointer select-none">Remember me</label>
                    </div>
